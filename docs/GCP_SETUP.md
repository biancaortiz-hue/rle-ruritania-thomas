...
- Access to the GCP project (e.g., `rle-ruritania-thomas`)
...
```bash
gcloud projects add-iam-policy-binding "rle-ruritania-thomas" \
  --member="serviceAccount:github-actions-rle@rle-ruritania-thomas.iam.gserviceaccount.com" \
...
```bash
gcloud projects describe rle-ruritania-thomas --format="value(projectNumber)"
```
...
gcloud iam service-accounts add-iam-policy-binding \
  "github-actions-rle@rle-ruritania-thomas.iam.gserviceaccount.com" \
  --project="rle-ruritania-thomas" \
...
| `GCP_SERVICE_ACCOUNT` | `github-actions-rle@rle-ruritania-thomas.iam.gserviceaccount.com` |
...
```
Caller does not have required permission to use project rle-ruritania-thomas.
